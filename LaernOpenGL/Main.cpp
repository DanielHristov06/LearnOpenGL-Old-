...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(1600, 900, "Wow, a window!", NULL, NULL);
	...
	glViewport(0, 0, 1600, 900); //Specify the viewport of OpenGL in the window
	...
	glClearColor(51.0f / 255.0f, 153.0f / 255.0f, 1.0f, 1.0f); //Specify the color of the background
